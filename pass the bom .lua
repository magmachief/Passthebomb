-- Roblox "Pass The Bomb" Script with Persistent Toggles for Auto Pass, Anti-Slippery, and Remove Hitbox
...
local function createYonkaiMenu()
    ...
    local function createToggleButton(defaultText, toggleFunction)
        ...
        button.Size = UDim2.new(0.8, 0, 0, 30) -- Smaller buttons
    ...
    print("Yonkai Menu loaded successfully.")
end
